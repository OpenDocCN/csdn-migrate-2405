...
![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/9705df93-43d7-4d61-a747-23ea31e54225.png)
...
![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/08e3a715-ebf8-4bec-acb8-bab8f8b1c958.png)
...
![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/3f37cf0b-bffa-4217-aa87-6b2ae057355f.png)

然后我们被提示指定安装的目标目录，我们期望的是安装后，该文件夹将包含我们在数据文件夹中汇总的所有文件和文件夹：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/205b591a-cfc4-4cf2-ba78-58238f6a3a10.png)

然后，我们将看到我们通过包目录定义的所有组件的列表，这种情况下只是`com.packtpub.cm`文件夹中的应用程序和依赖项：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/01881dcf-369b-463f-b905-267d30053ea9.png)

接下来，我们将看到我们在`packages.xml`中定义的任何许可证，包括文本文件中提供的许可证信息：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/ccff9ba7-834c-4e72-8ce1-0a5d5ac24cf5.png)

然后我们被提示设置开始菜单快捷方式，默认情况下由`config.xml`提供：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/058b12dd-aa3e-4869-9137-3904578bf55e.png)

我们现在已经准备好安装了，并在确认之前提供了磁盘使用情况统计信息：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/7af94f05-a95f-48d5-a092-0d683ae56cfc.png)

在安装完成时稍等片刻后，我们将看到最终确认对话框：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/lrn-qt5/img/16c6a965-1105-4705-bf3a-4487e1f71473.png)
