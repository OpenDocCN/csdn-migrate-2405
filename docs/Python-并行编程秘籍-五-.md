...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/2fba89a5-4840-407f-8266-63aab36b85ba.png)

Windpdb Reborn GUI

1.  如下截图所示，我们在第 12 行和第 23 行（红色高亮显示）分别插入了两个断点（使用断点菜单）：

***![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/5a2ccb87-7020-4948-8b20-80a3f393b972.png)***
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/1a27af00-4468-449f-88ee-ee0c6b9bb6a4.png)
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/b27f1402-d9ab-4924-bfa2-df62a894b50c.png)
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/70c4308b-78e8-4633-8a9c-7435c583eb9c.png)
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/92df2ec3-4eb3-43be-a8a0-f6351d39f5de.png)

1.  现在，你可以直接从提示符使用 telnet。通过输入`telnet`，应该会出现以下窗口：

![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/1e25886f-dca3-41a6-8e2a-efaf80ff5b05.png)
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/9f1b0949-3689-4ca7-9cd9-502cdaf6a028.png)

1.  在示例代码中，注意第 7 行的箭头。代码没有运行，只是等待执行指令：

![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-pll-prog-cb/img/1aa03050-e016-4563-94a9-b3418cef7ef4.png)
