...
1.  启动 Visual Studio 2012。在**Windows Store**下创建一个新的 C# **空白应用（XAML）**项目。![如何做...](https://github.com/OpenDocCN/freelearn-csharp-zh/raw/master/docs/mlt-trd-cs5-cb/img/7644OT_11_01.jpg)
