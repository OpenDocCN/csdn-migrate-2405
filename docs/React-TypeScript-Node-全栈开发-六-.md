...
1.  现在，Thread 路由屏幕看起来像这样，我们的新点数系统已经就位：![图 16.1-Thread 路由屏幕](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.01_B15508.jpg)
...
1.  现在，如果您再次加载`Thread`路由屏幕，您应该会看到我们 Thread 的`ThreadItems`。再次强调，您的本地数据会有所不同，因此请确保您的 Thread 包含`ThreadItem`数据及其相应的点数，以及如下屏幕截图所示的图标按钮：![图 16.2-ThreadItem 点](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.02_B15508.jpg)
...
![图 16.3 - 移动模式下的 Thread 路由屏幕](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.03_B15508.jpg)
...
![图 16.4 - 移动端的 Thread 路由屏幕与我们的点增量器](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.04_B15508.jpg)
...
1.  现在，如果我们在没有`id`的情况下运行主题路由，我们会得到以下屏幕：![图 16.6 - 新主题屏幕](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.06_B15508.jpg)
...
![图 16.7 - 主屏幕](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.07_B15508.jpg)
...
![图 16.8 - 带有正文的主屏幕](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.08_B15508.jpg)
...
![图 16.9 - 提交的 ThreadItem 响应图](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.09_B15508.jpg)
...
![图 16.10 – 获取热门分类主题排序结果](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.10_B15508.jpg)
...
![图 16.11 – 主屏幕显示热门分类](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/flstk-react-ts-node/img/Figure_16.11_B15508.jpg)
