...
![准备好...](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/mod-py-cb/img/Image00013.jpg)

在这里，*k*是来自`Counter`的键，*C*，*f[k]*是给定键的频率值来自`Counter`。

标准偏差*σ*取决于平均值*μ*。公式如下：

![准备好...](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/mod-py-cb/img/Image00014.jpg)

在这里，*k*是来自`Counter`的键，*C*，*f[k]*是给定键的频率值来自`Counter`。计数器中的项目总数是![准备好...](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/mod-py-cb/img/Image00015.jpg)。
