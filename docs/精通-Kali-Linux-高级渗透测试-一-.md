...
![使用 TrueCrypt 创建加密文件夹](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_01_23.jpg)
...
![侦察的基本原则](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_02_01.jpg)
...
![识别网络基础设施](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_07.jpg)
...
![指纹识别操作系统](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_08.jpg)
...
![指纹识别操作系统](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_09.jpg)
...
+   **审查默认网页**：一些应用程序安装了默认的管理、错误或其他页面。如果攻击者访问这些页面，它们将提供有关可能易受攻击的已安装应用程序的指导。在下面的屏幕截图中，攻击者可以轻松地识别已安装在目标系统上的 Apache Tomcat 的版本。![确定活动服务](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_10.jpg)

+   **审查源代码**：配置不良的基于 Web 的应用程序可能会对某些 HTTP 请求（如`HEAD`或`OPTIONS`）做出响应，其中包括 Web 服务器软件版本，可能还包括基本操作系统或正在使用的脚本环境。在下面的屏幕截图中，netcat 从命令行启动，并用于向特定网站发送原始`HEAD`数据包。这个请求生成了一个错误消息（**404 未找到**）；然而，它也确定了服务器正在运行 Microsoft IIS，版本 7.5。![确定活动服务](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_11.jpg)
...
![nmap](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_12.jpg)
...
1.  要启动应用程序，请在提示符下输入`recon-ng`，如下面的屏幕截图所示。启动屏幕将指示模块的数量，并且帮助命令将显示可用于导航的命令。![The recon-ng framework](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_13.jpg)
...
![The recon-ng framework](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_14.jpg)

1.  加载模块后，使用`set`命令设置选项，然后输入`run`执行，如下面的屏幕截图所示：![The recon-ng framework](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_15.jpg)
...
1.  完成注册和转换更新后，您将看到一个多面板的 GUI，允许您检查各种数据对象之间的连接，如下面的屏幕截图所示：![Maltego](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_16.jpg)
...
![Maltego](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_03_17.jpg)
...
![威胁建模](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_01.jpg)
...
![使用在线和本地漏洞资源](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_02.jpg)
...
![使用在线和本地漏洞资源](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_03.jpg)

许多漏洞利用程序都是以源代码形式提供的，必须在使用之前进行编译。例如，搜索 RPC 特定漏洞可能会识别出几种可能的漏洞利用程序。以下是摘录的一部分：

![使用在线和本地漏洞资源](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_04.jpg)
...
![使用在线和本地漏洞资源](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_05.jpg)
...
![使用在线和本地漏洞资源](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_06.jpg)
...
![Metasploit Framework](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_07.jpg)
...
![Metasploit 框架](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_08.jpg)
...
![Metasploit 框架](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_09_New.jpg)
...
![Metasploit 框架](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_10.jpg)
...
![Metasploit 框架](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_11.jpg)
...
![利用易受攻击的应用程序](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_12.jpg)
...
![利用易受攻击的应用程序](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_13.jpg)
...
![利用易受攻击的应用程序](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_14_New.jpg)
...
![使用 Armitage 攻击多个目标](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_15.jpg)

Armitage 允许您通过右键选择主机，然后转到**主机**菜单并选择**设置标签...**功能来设置主机标签。这允许您标记特定的地址或通过常用名称标识它，在团队测试时非常有帮助。这个过程在下面的截图中显示：

![使用 Armitage 攻击多个目标](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_16.jpg)
...
![使用 Armitage 攻击多个目标](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_17.jpg)
...
![编写 Armitage 攻击脚本](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_18.jpg)
...
![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_19.jpg)

Veil-Evasion 正在快速发展，每月发布重要版本，并更频繁地进行重要升级。目前，有 24 个有效载荷旨在通过加密或直接注入内存空间来绕过防病毒软件。这些有效载荷如下屏幕截图所示：

![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_20.jpg)
...
![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_21.jpg)
...
![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_22.jpg)

在下面的示例中，使用了`[tab]`命令来演示一些可用的有效载荷；然而，默认的（`windows/meterpreter/reverse_tcp`）被选择，如下面的屏幕截图所示：

![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_23.jpg)
...
![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_24.jpg)

最终屏幕显示生成的有效载荷信息，如下面的屏幕截图所示：

![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_25.jpg)
...
![绕过 ID 和防病毒检测](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_04_26.jpg)
...
![绕过 Windows 用户账户控制](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_01.jpg)
...
![查找和获取敏感数据-掠夺目标](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_04.jpg)
...
![查找和获取敏感数据-掠夺目标](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_05.jpg)
...
![查找和获取敏感数据-掠夺目标](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_06.jpg)
...
![使用 Metasploit 进行后渗透活动](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_07.jpg)
...
![使用 Metasploit 进行后渗透活动](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_08.jpg)
...
![使用 Metasploit 进行后渗透活动](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_09.jpg)
...
![使用 Metasploit 进行后渗透活动](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_10.jpg)

除了枚举，`winenum`脚本还会转储注册表并收集系统哈希以便解密，如下面的屏幕截图所示：

![使用 Metasploit 进行后渗透活动](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_11.jpg)
...
![使用隐身模式重播身份验证令牌](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_12.jpg)
...
![使用隐身模式重播身份验证令牌](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_13.jpg)

如你所见，一个委派令牌被识别为`管理员`。如果我们可以模拟这个令牌，我们就可以获得它的权限。

在`incognito`中调用`impersonate_token`命令（如下面的截屏所示），请注意命令中需要两个反斜杠：

![使用隐身模式重播身份验证令牌](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_14.jpg)
...
![使用 Windows 凭据编辑器操纵访问凭据](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_15.jpg)
...
![从管理员升级到 SYSTEM](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_16.jpg)

在安排`at`任务运行后，在`meterpreter`提示符下重新确认您的访问权限，如下面的屏幕截图所示：

![从管理员升级到 SYSTEM](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_17.jpg)
...
![掩盖你的行踪](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_18.jpg)

例如，受损系统的`C:`包含一个名为`README.txt`的文件。该文件的 MACE 值表明它是最近创建的，如下面的屏幕截图所示：

![掩盖你的行踪](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_19.jpg)
...
![掩盖你的行踪](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_20.jpg)
...
![掩盖你的踪迹](https://github.com/OpenDocCN/freelearn-kali-zh/raw/master/docs/ms-kali-adv-pentest/img/3121OS_05_21.jpg)
