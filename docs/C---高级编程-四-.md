...
![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_17.jpg)
...
1.  首次构建和运行练习。您将获得以下输出：![图 6.18：执行练习 9，第 1 部分的结果](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_18.jpg)
...
1.  再次构建和运行应用程序。现在，您将获得一个"脏"的、混合的输出，如下所示：![图 6.19：执行练习 9，第 2 部分的结果](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_19.jpg)
...
![图 6.20：应该实现的类的描述](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_20.jpg)

###### 图 6.20：应该实现的类的描述

我们在美术馆模拟器项目中已经实现了以下类：

![](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_21.jpg)

###### 图 6.21：美术馆模拟器项目中已实现的类的表格

在开始实现之前，让我们将新的类添加到类图中。所有描述的类及其关系都组成了以下图表：

![图 6.22：类图](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_22.jpg)

###### 图 6.22：类图

为了以期望的格式接收输出，`LoggerUtils`类应该具有以下`static`函数：

![图 6.23：LoggerUtils 成员函数的描述](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_23.jpg)
...
![图 6.24：应用程序执行的结果](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/adv-cpp/img/C14583_06_24.jpg)
