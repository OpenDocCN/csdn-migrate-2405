...
![图像命令](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_02.jpg)
...
1.  要设置自动构建，请登录到您的 Docker Hub 帐户。![自动构建](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_03.jpg)

1.  通过**链接** **帐户**菜单链接您的 GitHub 或 BitBucket 帐户。

1.  在**添加** **存储库**菜单中选择**自动** **构建**。![自动构建](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_04.jpg)
...
1.  指定 Dockerfile 的位置。默认为`/`。![自动构建](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_05.jpg)
...
![自动构建](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_06.jpg)
...
1.  转到存储库中的**Settings**。![Webhooks](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_09.jpg)

1.  从左侧菜单栏转到**Webhooks** **and** **Services**。![Webhooks](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_10.jpg)

1.  单击**Add** **Service**。![Webhooks](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_11.jpg)

1.  在打开的文本框中，输入**Docker**并选择该服务。![Webhooks](https://github.com/OpenDocCN/freelearn-devops-zh/raw/master/docs/ocs-dkr/img/4787OS_02_12.jpg)
