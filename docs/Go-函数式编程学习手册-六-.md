...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/9b96a9e7-638f-4643-85a9-d800899098a9.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/4a47ca09-1a9b-49bc-998c-93ea6ccf9830.png)

##### 使用旅行费用的组合操作示例

在下面的组合表中，我们输入了从美国到欧洲旅行的预算：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/5f36d0f4-d1cb-4cbc-a5dc-c5a4e96def82.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/ed77bf35-b1ea-4c23-ad3f-7b5abeb4c213.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/a6ac962d-0694-441e-98c5-1e1bc6df014b.png)

为什么这是无效的？看起来像是组合，但真的吗？

下一个例子应该更明显一些。（有趣，但显然不是一个范畴。）

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/5d5a6493-a646-4f48-8261-17fa621c07d5.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/135cce5f-678e-4afe-970a-ad9a309dcbf2.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/c00c08cc-ac82-4fb7-b920-bf841aa54bf8.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/31746fff-0c56-4b8d-86f5-6c20a024716b.png)

每个对象都有一个指向自身的态射。

当我们有多个对象时，我们用下标来表示我们正在谈论哪个 ID，例如**idA**。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/cf1de571-5404-4247-892e-05a9839dfecb.png)

这个图说的是*f o idA  = f*。

换句话说，**idA**之后的**f**的态射与**f**的态射相同。这里有一个具体的例子：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/4e7c29f9-e39a-4762-a3c8-c13a2de591ef.png)

自然数 3 的恒等态射是一个将任何数乘以

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/ce4eb718-cc2a-43fb-b69e-adac25484348.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/f4af522e-e395-47c1-b6aa-cf7a5855bca3.png)

从下面的图中，我们看到**ho(gof)**和**(hog)of**是相同的。

因此，我们的范畴遵守结合律。下一个图是组合的结合性的另一个例证：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e8ef1f15-6cce-47ca-9a7b-f4f0c68ce59c.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/23f024a7-63fc-4025-98a4-01c54136f217.png)

如果我们取 A 和任何 f 到 B 和**A (1A)**上的恒等物，则在 A 上的恒等物之后的复合 f (**f** o **1A**)等于 f。

这是另一种看待它的方式：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/6aff6f48-45d1-4bec-9b47-fa5e771a672b.png)

如果我们取**A**和任何**f**，并且我们取**A**上的恒等物，那么这个复合**f**在**A**上的恒等物之后等于**f**。

这是从 A 到 B 的态射 f：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/fb4c84db-0473-47b9-a902-db6132f6dc9d.png)

这里有一个具体的例子：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/80334cbc-eb56-427b-a5ef-45d03bc822fc.png)

恒等公理表明，如果有一个从**A**的恒等物到**B**的箭头 f，以及一个从**B**的恒等物到**B**的箭头 f，那么从**A**到**B**的箭头就是相同的箭头**f**。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/b4541002-bc1f-4737-8b81-9e5ebdcac7cf.png)

结合性公理表明箭头的组合是可结合的，这又是说图表是可交换的另一种方式。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/bc412540-f44d-440d-8d2e-2c7edfdc8bf3.png)
...
！[](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/dd10fefd-97eb-44ef-9062-69e8a396270c.png)
...
！[](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/edad6217-bd3b-4f71-8daf-7d1a34def666.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/040b0267-99d7-46a0-89bd-6027ed1141fb.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/7f35c02e-f1fa-47a8-aea2-65a139641f39.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/9c7bccfb-c779-49ee-8b74-ef8456d4ad27.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/5ca714ed-2a7f-4b8f-8901-90e60e05d3f6.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/457eed58-25de-44a0-84e4-e59c467c3c5d.png)

#### 满射态射

满射态射是指共域 B 中的每个对象都与定义域 A 中的一个态射相连。换句话说，B 中的每个对象都具有 f(x)的值，其中 x 在 A 中。这种映射被称为“多对一”，因为从 A 到 B 中的单个对象有多个映射。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/11ce691e-4149-4c00-bcb1-02424b3399aa.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/b2ebd323-545d-4c5e-bc53-b4ed8e6f2a06.png)
...
| **态射** | **描述** | **图表** | **例子** |
| --- | --- | --- | --- |
| Epi- | 满射“到” |  ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e87a0bfa-eb1d-43e5-8dde-ca3ba78923a3.png)A → B ⇉ C | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/66fcffdf-715e-4006-ab7f-fe1b58b89f6d.png) |
| **单**- | 单射“1 对 1” | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/a9f4521c-a16d-4f3a-8cee-8ca21bbad66e.png) C ⇉ A → B | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/548b8b4f-6993-45db-9c5f-de9bccad306c.png) |

| **同构**- | 双射“到”和“1 对 1” 双射 = 单射 + 满射

域中的每个元素都将有一个对应的范围中的元素（也称为“余域”）。 | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/8a7d96d5-dfb8-411c-9bf2-004f464a61df.png) A ⇄ B | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/a49eeef4-a5b0-451a-a4b5-12db3b88c0aa.png)G 和 H 之间的同构。有序对：f(a) = 1, f(b) = 6,... f(j) = 7 |

| **自同**- | 从一个结构到它自身。自同态是一个定义域等于范围的同态。 | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/b0798445-c7ef-4428-961a-e611da50b5d2.png) A → A | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e791f956-01c1-4971-abf3-18b9fac98ea5.png)相同的像素，重新排列。 |
| --- | --- | --- | --- |
| **自动**- | 双射态射是一个同时也是同构的态射；与自身同构。自同态 = 双射 + 同态 | ![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e3fd3966-1a4f-40e2-95ee-82a616668e57.png) |
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/58656498-f5d8-4eaa-a080-27d33efe7f61.png)

这是第一个分解：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/afc2b6a2-5122-4a0e-b4fb-944e69f840fd.png)

这是第二个分解：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/d2a1e98f-1552-4792-8863-295c8d222fa0.png)

我们一直在并行地连接我们的组件；我们也可以（解）组合它们串行地：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/1eda8918-5be2-4b15-bf96-50b5975b4582.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/8ed090c6-eef5-447f-aa58-e29d8756aaea.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/2948b2f9-5f11-4f90-90ec-4572e5ee5c4e.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/25d16cc6-3d4b-44b0-aa74-f384708ca0a0.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/5fa7cba4-1290-471a-9419-9f0973412b15.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/23e24919-e68d-4ce3-8f42-78a4fc883f9f.png)

如果太阳正好在头顶上，并在球场上投下影子，那么我们可以知道 x，y 坐标。如果我们还可以测量球移动时的高度，那么我们就知道 z 坐标。结合这两个信息，我们就可以知道球在三维空间中的位置。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/10f298af-00a0-4c58-a3d5-fab9db32b48c.png)

下图表示如果我们知道 A 和 B，那么我们也知道 C。

在范畴论中，这被称为两组箭头 f 和 g 的乘积<f,g>。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/259b6ab1-3465-48a0-b5b9-6f1fcb129def.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/c7433e75-2208-463a-8fdd-9659fe677c75.png)

下图描述了求和运算：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/00fd4d03-b4ee-46ac-93b3-5c24cca35016.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/56e516dd-d44a-4fc2-a8b5-fc2ff0f466a2.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/2eadab28-61e4-4b84-a07b-32df3ae096bd.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/32d600db-94cd-4725-975e-11e08ba2f42e.png)

## 求和、乘积、指数和类型的乐趣

这是有牛、老虎和大象的总和：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/d09d84fa-bc0e-442f-9d00-d446a92579ae.png)

这是有牛、老虎和大象的乘积：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/2e47f7a3-ffd2-4eef-911c-c46aa6995979.png)

这是有牛、老虎和大象的指数：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e0c100bd-258b-4e0a-85d0-e1b29eccf934.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/59258b9f-d2d3-4c07-9057-a4e290c32dd8.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/c98c2d34-9ad8-46ae-9eef-ac63311b2d70.png)

我们的总和与乘积同构。左边的老虎和右边的老虎彼此*对偶*。大象和足球也是如此。老虎的对偶被称为余老虎。同样，总和被称为余积。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/49b65af9-69c6-44f9-a54e-587422dd6d83.png)

下面显示了一个单态射。**f**是*单调*：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/c4d072d2-8e0a-48eb-afda-ac35b581e0fb.png)

下面显示了一个满态射。**f**是*史诗*的：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/683a70a8-e237-437d-80da-329f9ae5366b.png)

以下图表显示单态射与满态射是对偶的。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/1ea69afd-5d9c-4a33-ac71-924445c34667.png)

如果我们从老虎到大象再到老虎不丢失数据：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/b1329f40-4346-491d-a223-6e3dcfdce68e.png)

同样，我们从大象到老虎再到大象也不会丢失数据：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/a07790de-b31a-4a54-a638-354eba7e1b18.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/bf534933-2b3f-4405-a547-dfe8e803e9a6.png)

当他点击提交按钮时，数据从一个端点流向另一个端点。随着数据的流动，它可能以某种方式进行转换，但数据的结构保持不变：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/3371fc32-d0fd-4af0-a450-dd4bf550c046.png)
...
![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e98700e3-ee70-46e4-80a7-14397eab3157.png)

和一个 I/O Monad：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/4b578bfa-0468-4566-aacb-7195ff39ed43.png)

变得有用。

我们可以从服务器日志中读取数据，并集成一个图形用户界面（GUI），以呈现用户可以查看并从中获得理解的方式呈现的演示。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/f8cd539c-5028-41c5-beba-08768c3f8845.png)

如果我们的数据有对应的模式呢？

我们能将数据的呈现推广到不同的布局吗？例如，电子表格程序允许用户基于相同的行和列显示不同类型的图表（饼图、条形图等）。如果我们可以做到这一点，那么以下是可行的：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/e31d8175-e4e2-47f5-916f-913f396bfe97.png)

从实际的角度来看，我们日志文件中的数据可能会进入具有行和列的表格，就像电子表格一样。从类别的角度来看，我们可以说我们的模式是对象实例和它们的属性的笛卡尔积：模式=实例 x 属性。

然后我们可以合并我们的图表得到这个：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/58bbf8fc-cd35-476b-9c12-b81ddf5c6ea0.png)

现在，如果我们想要允许用户输入查询以获得对其领域的工作知识，我们可以得到以下的图表：

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/2f47ccad-f0b3-459c-bb7b-29424570d637.png)

这里显示的类别定义了一个良好的可视化过程；如果箭头、对象和数据准确无误，那么图表就会通行无阻。我们可以确信我们获得的知识是可靠的。

![](https://github.com/OpenDocCN/freelearn-golang-zh/raw/master/docs/lrn-fp-go/img/4e8c54bb-9e39-431f-92c3-247822fe86cc.png)
