...
![Bruteforce Exploit Detector (BED)](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_01.jpg)
...
![Bruteforce Exploit Detector (BED)](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_02.jpg)
...
![Bruteforce Exploit Detector (BED)](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_03.jpg)
...
![使用 Fast-Track 进行客户端攻击](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_04.jpg)

现在任何连接到该服务器的系统都将遇到以下网页：

![使用 Fast-Track 进行客户端攻击](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_05.jpg)
...
![社会工程工具包](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_06.jpg)
...
![社会工程工具包](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_07.jpg)
...
![社会工程工具包](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_08.jpg)

选择默认的监听端口 443 并按*Enter*继续。就是这样！现在您所要做的就是等待有人连接到您的 Web 服务器。如果您有一个可用的 Windows 机器并浏览到该网站，您将看到以下网站：

![社会工程工具包](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/7744OS_06_09.jpg)
...
![使用 Armitage 进行后期利用](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_01.jpg)
...
![枚举](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_02.jpg)

输入`192.168.75.0/24`来扫描正确的 VLAN1 子网。

![枚举](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_03.jpg)

扫描将需要一些时间来完成。完成后，将会出现一条消息，指出扫描已经完成，应该使用**Find Attacks**选项来…找到攻击。

![枚举](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_04.jpg)

如果网络设置正确，你应该会看到类似以下截图的内容：

![枚举](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_05.jpg)
...
![利用](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_06.jpg)

现在是时候利用 ms08_067 漏洞接管这台 Windows XP 机器了。很少有漏洞利用像这样一致和简单。在工作区中右键单击 Windows 系统图标，选择**Attack** | **smb** | **ms08_067_netapi**。

![利用](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_07.jpg)

配置菜单将会出现。一切都将填写完毕，准备就绪。点击**Launch**继续。

![利用](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_08.jpg)

如果一切正常工作，工作区中的图标将会变成类似以下截图的内容：

![利用](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_09.jpg)
...
![我们已连接，现在怎么办？](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_10.jpg)

使用菜单，我们可以快速查看系统进程，同时使用**Meterpreter 3** | **Explore** | **Show Processes**菜单选项：

![我们已连接，现在怎么办？](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_11.jpg)
...
![我们已连接，现在怎么办？](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_12.jpg)
...
![网络详细信息](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_13.jpg)

这绝对是在现实世界中看到的一种令人愉悦的信息。这个特定的系统有两张不同的网络卡，而且这个系统可能被用来探索 192.168.50.0/24 网络的可能性很高。在我们继续之前，我们应该查看一下路由表和其他网络信息。

![网络详细信息](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_14.jpg)
...
![网络详细信息](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_15.jpg)
...
![网络详细信息](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_16.jpg)
...
![查找安装的软件和工具](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_17.jpg)
...
![查找安装的软件和工具](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_18.jpg)
...
![枢纽](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_19.jpg)

你将看到一个菜单，选择你的枢纽点。选择`192.168.50.0`，然后点击**添加枢纽**。

![枢纽](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_20.jpg)
...
![枢纽](https://github.com/OpenDocCN/freelearn-sec-zh/raw/master/docs/adv-pentest-hisec-env/img/77440S_07_21.jpg)
