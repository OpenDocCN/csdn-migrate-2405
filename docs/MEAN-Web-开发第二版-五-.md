...
![配置 ESLint](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_01.jpg)
...
![调试你的应用程序](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_02.jpg)

以调试模式运行

正如你所看到的，`debug`脚本邀请你通过使用兼容的浏览器访问`chrome-devtools://…`来开始调试应用程序。在 Google Chrome 中打开这个 URL，你应该会看到一个类似以下截图所示的界面：

![调试你的应用程序](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_03.jpg)
...
![使用 Angular Augury](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_04.jpg)
...
![组件树](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_05.jpg)
...
![组件树](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_06.jpg)

带有表单的 Augury

正如您所看到的，您可以检查您的表单状态并了解其内部状态。如果您编辑表单输入的值，您还将能够在右侧窗格上实时看到其状态更新。如果单击**注入器图**选项，您将能够看到 Angular 的注入器是如何工作以及当前组件的注入提供程序：

![组件树](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_07.jpg)
...
![路由树](https://github.com/OpenDocCN/freelearn-node-zh/raw/master/docs/mean-webdev-2e/img/B05071_11_08.jpg)
