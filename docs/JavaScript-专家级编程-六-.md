...
1.  首先运行`npx parcel serve exercise-refactor-action-creators-start.html`。要在开发过程中查看应用程序，请运行`npm run Exercise79`。您将看到应用程序正在启动，如下所示：![图 10.33：运行此练习的起始文件](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_33.jpg)
...
![图 10.38：GraphiQL 用户界面和获取完全展开的篮子项目](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_38.jpg)
...
1.  运行`node exercise-graphql-micro-start.js`。然后，在开发过程中，运行`npm run Exercise81`。您将看到应用程序启动，如下所示：![图 10.39：运行此练习的起始文件](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_39.jpg)

###### 图 10.39：运行此练习的起始文件

1.  转到`http://localhost:3000`（或者起始脚本输出的任何 URL）。您应该看到以下 GraphiQL 页面：![图 10.40：空的 GraphiQL 用户界面](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_40.jpg)
...
![图 10.41：带有 LineItemCost 别名的 ID“1”和“2”的 mutation 查询的 GraphiQL](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_41.jpg)
...
![图 1.62：准备在控制台选项卡中运行的代码](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_01_62.jpg)

###### 图 1.62：准备在控制台选项卡中运行的代码

按下*Enter*执行代码后，您应该在控制台中看到打印的 CSV，如下所示：

![图 1.63：带有代码和控制台选项卡输出的商店](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_01_63.jpg)
...
![图 2.7：从 node.js 调用应用程序](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_02_07.jpg)
...
![图 4.24：从签到端点获取 TOKEN](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_04_24.jpg)
...
![图 4.25：一个四位一次性代码](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_04_25.jpg)
...
![图 4.26：运行命令两次会导致错误](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_04_26.jpg)
...
![图 5.20：带有闪光模式的灯泡](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_05_20.jpg)
...
1.  通过运行`npm install --save-dev husky`安装`husky`作为开发人员依赖项：![图 6.19：安装 Husky](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_06_19.jpg)
...
![图 6.20：显示两个测试的正面结果](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_06_20.jpg)
...
![图 7.62：运行 log_users.js 的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_07_62.jpg)
...
![图 7.63：显示 TEST PASSED 消息的屏幕截图](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_07_63.jpg)
...
1.  打开`Activity03.js`；它应该包含用传统 JavaScript 编写的各种函数。当您使用 Node.js 运行`Activity03.js`时，您应该看到以下输出：![图 7.64：运行 Lesson7-activity.js 后的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_07_64.jpg)
...
![图 7.65：显示 TEST PASSED 消息的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_07_65.jpg)
...
![图 8.43：使用现有 ID 调用函数](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_08_43.jpg)
...
![图 8.44：使用不存在的 ID 调用函数](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_08_44.jpg)
...
![图 8.45：在一个用户上调用 calculate](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_08_45.jpg)
...
![图 8.46：调用 calculateAll 函数](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_08_46.jpg)
...
![图 9.50：发出低电量警报](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_09_50.jpg)
...
![图 9.51：对检测器对象发出的警报](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_09_51.jpg)
...
![图 9.52：测试检测器上的发出警报](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_09_52.jpg)
...
1.  修改`test.txt`中的一些内容并保存。您应该看到以下输出：![图 9.53：修改`test.txt`文件内容后的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_09_53.jpg)
...
![图 9.54：可以使用 startWatch 函数看到对文件所做的修改](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_09_54.jpg)
...
![图 9.55：更改文件监视器后的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_09_55.jpg)
...
1.  运行`parcel serve activity-on-checkout-prop-start.html`，然后执行`npm run Activity15`。您将看到应用程序启动，如下所示：![图 10.42：运行 start html 脚本后的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_42.jpg)

###### 图 10.42：运行 start html 脚本后的输出

1.  转到`http://localhost:1234`（或者启动脚本输出的任何 URL）。您应该看到以下 HTML 页面：![图 10.43：浏览器中的初始应用程序](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_43.jpg)
...
![图 10.44：单击“继续结账”按钮后的输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_44.jpg)
...
1.  运行`npm run Activity16`（或`node activity-items-selector-test-start.js`）。您将看到以下输出：![图 10.45：运行活动的初始启动文件后的预期输出](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_45.jpg)
...
![图 10.46：最终输出显示没有错误](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_46.jpg)
...
1.  运行 Activity 17 的 BFF 和`npx parcel serve activity-app-start.html`。在开发过程中，运行`npm run Activity17`。您将看到应用程序启动，如下所示：![图 10.47：运行活动的初始启动文件](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_47.jpg)

###### 图 10.47：运行活动的初始启动文件

1.  转到`http://localhost:1234`（或者启动脚本输出的任何 URL）。您应该看到以下 HTML 页面：![图 10.48：浏览器中的初始应用程序](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_48.jpg)
...
![图 10.49：带有购物篮查询的 GraphiQL UI](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_49.jpg)
...
![图 10.50：一旦与 BFF 集成，最终应用程序](https://github.com/OpenDocCN/freelearn-js-zh/raw/master/docs/prof-js/img/C14587_10_50.jpg)
