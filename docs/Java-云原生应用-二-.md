...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/c281d1ed-3aae-4f73-ae03-1ffdc9694a6e.png)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/c1ba1fe6-d65b-48e3-a52d-493e594b36bf.png)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/f7c9ea7f-4822-4601-b318-9d079e137d2f.jpg)

在蓝绿部署的第一阶段，使用新版本的应用程序的一组新实例被配置并变为可用。在这个阶段，新的绿色应用实例对最终用户不可用，并且部署在内部进行验证。如下所示：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/3337e8ca-4e65-4196-b35b-125c16a298c0.jpg)

在部署的下一个阶段，路由器上会打开一个象征性的开关，现在开始将所有请求路由到绿色实例，而不是旧的蓝色实例。旧的蓝色实例会保留一段时间进行观察，如果检测到任何关键问题，我们可以根据需要快速回滚部署到旧的应用实例：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/180fc891-da2a-4ec2-8bb1-ca2ac06e6c4f.jpg)

在部署的最后阶段，应用的旧蓝色实例被废弃，绿色实例成为下一个稳定的生产版本：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/21619477-0763-44a9-83d3-f945bb33dd27.jpg)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/76b22168-fae1-4ec4-a902-9b3f0cc10699.jpg)

当发布应用程序的新功能需要与一些测试用户进行测试，然后根据这些用户群的反馈进行全面发布时，这种方法尤其有用。一旦确定绿色环境准备好全面发布，绿色环境的实例将增加，同时蓝色环境的实例将减少。以下是一系列图表的最佳说明：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/b668e3dc-825b-46c1-b9ed-85e2d32535f6.jpg)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/56901c5c-41af-48b3-b314-6315c6e06ff0.png)

在流水线配置中，指定 GitHub 仓库和 Git 仓库中`Jenkinsfile`的路径：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/f9c530a7-f018-4e4e-ac6a-8a4f1e0d0f25.png)

运行构建后，应该会构建出两个构件：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/cld-ntv-app-java/img/ecbf5ebc-5677-4959-9b5f-6d59d4cfedc0.png)
