...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/70fd5b75-23b5-4275-b212-bb5b974061dc.png)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/804808bc-52af-40a7-be2c-1ea1286bcde8.png)

1.  在浏览器中打开`http://localhost:9090`，以查看 Prometheus 控制台。在空文本框中输入`go_gc_duration_seconds`，然后单击执行按钮以显示捕获的指标。您可以切换到图形版本的选项卡以可视化数据：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/7a5e02c6-6401-4eb0-be61-01832f3f8fc4.png)

前面的指标是用于 Prometheus 本身的。您可以导航到`http://localhost:9090/targets`以查找 Promethues 监视的目标，如下所示：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/f07d688a-c972-46fc-9fbb-63bb1da19831.png)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/02e97a6b-0504-47fb-bbc7-93e9c63e2a59.png)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/ddf35ffd-8415-47d6-bd39-15c400d80707.png)

1.  打开`http://localhost:8080/actuator/prometheus`以查看 Prometheus 理解的格式中的指标：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/07b55bf4-6d26-4cd8-88d4-bbfda24bbb31.png)
...
![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/83686243-24fd-45a4-a616-2473f8fc4249.png)

1.  我们可以通过访问`http://localhost:9090/graph`，在文本框中输入`jvm_memory_max_bytes`，然后单击执行来绘制从指标捕获的指标的图表：

![](https://github.com/OpenDocCN/freelearn-java-zh/raw/master/docs/java11-cb/img/92e2a62a-ac7d-4d2c-a45f-717c9058a108.png)
