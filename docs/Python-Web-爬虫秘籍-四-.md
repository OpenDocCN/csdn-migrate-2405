...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/db8027f8-ba93-421c-a026-fb2cedd5ddcb.png)Elastic Cloud 注册页面

1.  输入您的电子邮件并点击“开始免费试用”按钮。当邮件到达时，请进行验证。您将被带到一个页面来创建您的集群：

![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/c08434c1-5481-4c1f-8582-674152731121.png)集群创建页面
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/c8d98099-d766-43d2-9825-62dc4ddd9b9c.png)Elastic Cloud 账户的凭据信息我们不会在任何示例中使用 Cloud ID。

1.  接下来，您将看到您的端点。对我们来说，Elasticsearch URL 很重要：

![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/054dab3f-ed34-43a7-9cab-099198e4bc8a.png)
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/8cba8c2e-8870-4c2c-a721-4a1787387ad8.png)Kibana 登录页面

1.  输入您的用户名和密码，然后您将进入主仪表板：

![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/6aff28f8-f90a-4018-a809-990fceae344a.png)创建索引模式
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/951c8ef3-95f8-454a-b76c-7315b6f68b47.png)创建的索引

1.  现在点击 Discover 菜单项，您将进入交互式数据浏览器，在那里您将看到我们刚刚输入的数据：

![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/3c49c59b-7f1d-4f48-b3bc-081f342a95b8.png)添加到我们的索引的数据
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/f67ea806-ca40-49f7-a2f1-fd561116c372.png)AWS IAM 凭证
...
![](https://github.com/OpenDocCN/freelearn-python-zh/raw/master/docs/py-web-scp-cb/img/9fa87343-5f4c-439a-abc8-f79339dfcd9b.png)
