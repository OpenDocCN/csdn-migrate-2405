...
![图 0.25：指定数据目录](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/cpp-ws/img/B16385_Preface_0.25.jpg)
...
![图 1.6：具有固定大小和仅分配一个索引的引用类型数组](https://github.com/OpenDocCN/freelearn-c-cpp-zh/raw/master/docs/cpp-ws/img/B16835_01_06.jpg)
